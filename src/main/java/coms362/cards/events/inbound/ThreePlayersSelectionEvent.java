...
public class ThreePlayersSelectionEvent implements Event, EventFactory, SysEvent {

    public static final String kId = "threeplayersselectionevent";
    private String socket = "";

    public static Event createEvent(SocketMessage sktEvent) {
        return new ThreePlayersSelectionEvent();
    }
