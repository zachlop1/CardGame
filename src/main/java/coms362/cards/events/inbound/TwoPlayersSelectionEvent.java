...
public class TwoPlayersSelectionEvent implements Event, EventFactory, SysEvent {

    public static final String kId = "twoplayersselectionevent";
    private String socket = "";

    public static Event createEvent(SocketMessage sktEvent) {
        return new TwoPlayersSelectionEvent();
    }
